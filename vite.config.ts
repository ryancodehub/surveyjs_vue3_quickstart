  ...
  return {
    ...
    server: {
      proxy: {
        "/save-survey": {
          ...
          changeOrigin: true,
          rewrite: (path) => path.replace(/^\/save-survey/, "/save-survey"),
        },
      },
      watch: {
        ignored: ["survey-creator-vue", "survey-vue3-ui"].map(
          (m) => `!**/node_modules/${m}/**`
        ),
      },
    },
    ...
    optimizeDeps: {
      ...
      include: [
        "survey-creator-core",
        "survey-core",
        "survey-creator-core/survey-creator-core.i18n",
    ...
    resolve: {
      ...
      alias: {
        ...
        "survey-creator-core": fileURLToPath(
          new URL("./node_modules/survey-creator-core", import.meta.url)
        ),
      },
    },
  };
